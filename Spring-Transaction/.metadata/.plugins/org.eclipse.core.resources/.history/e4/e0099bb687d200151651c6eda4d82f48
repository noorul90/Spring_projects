...
public class DTMTest {
	...
	public static void main(String[] args) {
		...
		//Positive Testcase
		//controller.register("John", "X", "M", new Date(), "HONDA", "ACTIVA","R007", "E523362", "CH5426", new Date(), new Date());
		
		//Negative Testcase
		controller.register("Will", "Smith", "M", new Date(), "HONDA", "GUSTO", "R542", "EN5562", "CH5521", new Date(), new Date());
	}
